...
<html lang="pt-BR">
    ...
    <body class="sp-video">
        ...
        $titulo_descritivo = get_field('titulo_texto_descritivo');
        $texto_descritivo = get_field('texto_descritivo_');

        if (get_field('tipo_de_video') == 'embed'){
            $video = $embed_video;
        }
        else{
            $urlvideo = get_field('url_do_youtube');
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php 
                            ...
                            if( have_rows('lista_de_beneficios') ){
                                echo '<ul>';
                                // loop through the rows of data
                                while ( have_rows('lista_de_beneficios') ) {
                                    the_row();
                                    // display a sub field value
                                    echo '<li>';
                                    the_sub_field('subitem');
                                    echo '</li>';
                                }
                                echo '</ul>';
                            }
        ...
        <?php require_once(plugin_dir_path(__FILE__) . '../inc/caixas-texto.php'); ?>
