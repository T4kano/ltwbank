...
<html lang="en">
    ...
    <body class="registro-webinario">
        ...
        $data_webinario = get_field('data_do_webinario');
        $data_webinario = explode('/', $data_webinario);
        require_once(plugin_dir_path(__FILE__) . '../inc/form.php');
        
        $data_extenso = get_field('informacoes');
        $informacoes_webinario = get_field('informacoes_webinario');
        $foto_palestrante = get_field('foto_do_palestrante');
        $texto_palestrante = get_field('texto_palestrante');
        
        $informacoes_inscritos = get_field('informacoes_finais');
        ?>
        <div id="header">
            <div class="container">
