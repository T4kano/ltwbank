...
<html lang="en">
    ...
    <body class="sp-padrao congresso-palestrantes-1">
        ...
        $destaque_palestrante = get_field('destaque_palestrante');
        $exibir_entre_datas = get_field('mostrar_captura');
            ...
            <div class="container omega">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if( have_rows('dias_palestras') ){
                             // loop through the rows of data
                            $cont = 0;
                            while ( have_rows('dias_palestras') ){
                                the_row(); 
                                if (get_row_layout() == 'dia'){ $cont++; ?>
                            
                        <h2 class="titulo-dia"><?php the_sub_field('data_dia'); ?> | <?php the_sub_field('descricao_dia'); ?></h2>
                        <?php
                                }else{
                        ?>
                        <div class="palestra">
                            <div class="palestra-inner">
                                <div class="col-md-2">
                                    ...
                                    <?php
                                        if (get_sub_field('foto_do_palestrante') == '')
                                            $foto = $theme_path . '/images/avatar.jpg';
                                        else
                                            $foto = get_sub_field('foto_do_palestrante');
                                    ?>
                                        <img src="<?php echo $foto; ?>" />
                                    </div>
                                    <div class="datahora">
                                        <?php 
                                            the_sub_field('hora_da_palestra');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="nome">
                                        <?php 
                                            if ($destaque_palestrante == 'nome')
                                                the_sub_field('nome_do_palestrante');
                                            else
                                                the_sub_field('tema_da_palestra');
                                        ?>
                                    </div>
